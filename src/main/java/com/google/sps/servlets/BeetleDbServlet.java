...
/** Servlet that returns JSON that contains a list of databases. */
@WebServlet("/databases")
public class BeetleDbServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    listDatabases.add("example-db");
    listDatabases.add("example-db-2");
    listDatabases.add("example-db-3");
    listDatabases.add("example-db-4");
